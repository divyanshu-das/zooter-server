<?php
App::uses('PlaceRating', 'Model');

/**
 * PlaceRating Test Case
 *
 */
class PlaceRatingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PlaceRating = ClassRegistry::init('PlaceRating');
	}
