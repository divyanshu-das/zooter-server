<?php
App::uses('FanClubMember', 'Model');

/**
 * FanClubMember Test Case
 *
 */
class FanClubMemberTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FanClubMember = ClassRegistry::init('FanClubMember');
	}
