<?php
App::uses('PlacesImage', 'Model');

/**
 * PlacesImage Test Case
 *
 */
class PlacesImageTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PlacesImage = ClassRegistry::init('PlacesImage');
	}
