<?php
App::uses('MatchBallScore', 'Model');

/**
 * MatchBallScore Test Case
 *
 */
class MatchBallScoreTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MatchBallScore = ClassRegistry::init('MatchBallScore');
	}
