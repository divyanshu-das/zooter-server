<?php
App::uses('PlaceCoach', 'Model');

/**
 * PlaceCoach Test Case
 *
 */
class PlaceCoachTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PlaceCoach = ClassRegistry::init('PlaceCoach');
	}
