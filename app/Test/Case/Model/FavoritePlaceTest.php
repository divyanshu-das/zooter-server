<?php
App::uses('FavoritePlace', 'Model');

/**
 * FavoritePlace Test Case
 *
 */
class FavoritePlaceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FavoritePlace = ClassRegistry::init('FavoritePlace');
	}
