<?php
App::uses('PlacesCost', 'Model');

/**
 * PlacesCost Test Case
 *
 */
class PlacesCostTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PlacesCost = ClassRegistry::init('PlacesCost');
	}
