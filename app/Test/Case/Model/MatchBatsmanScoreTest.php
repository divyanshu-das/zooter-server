<?php
App::uses('MatchBatsmanScore', 'Model');

/**
 * MatchBatsmanScore Test Case
 *
 */
class MatchBatsmanScoreTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MatchBatsmanScore = ClassRegistry::init('MatchBatsmanScore');
	}
