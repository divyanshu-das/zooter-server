<?php
App::uses('PlaceReview', 'Model');

/**
 * PlaceReview Test Case
 *
 */
class PlaceReviewTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PlaceReview = ClassRegistry::init('PlaceReview');
	}
