<?php
App::uses('FanClubFavorite', 'Model');

/**
 * FanClubFavorite Test Case
 *
 */
class FanClubFavoriteTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FanClubFavorite = ClassRegistry::init('FanClubFavorite');
	}
