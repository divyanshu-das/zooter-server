<?php
App::uses('TransactionalEmailsController', 'Controller');

/**
 * TransactionalEmailsController Test Case
 *
 */
class TransactionalEmailsControllerTest extends ControllerTestCase {
