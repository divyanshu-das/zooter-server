<?php
App::uses('FanClubFavoriteMembersController', 'Controller');

/**
 * FanClubFavoriteMembersController Test Case
 *
 */
class FanClubFavoriteMembersControllerTest extends ControllerTestCase {
