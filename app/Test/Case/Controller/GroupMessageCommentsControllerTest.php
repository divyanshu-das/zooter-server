<?php
App::uses('GroupMessageCommentsController', 'Controller');

/**
 * GroupMessageCommentsController Test Case
 *
 */
class GroupMessageCommentsControllerTest extends ControllerTestCase {
