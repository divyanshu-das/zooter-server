<?php
App::uses('HolidayDestinationsController', 'Controller');

/**
 * HolidayDestinationsController Test Case
 *
 */
class HolidayDestinationsControllerTest extends ControllerTestCase {
