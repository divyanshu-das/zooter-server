<?php
App::uses('MatchInningScorecardsController', 'Controller');

/**
 * MatchInningScorecardsController Test Case
 *
 */
class MatchInningScorecardsControllerTest extends ControllerTestCase {
